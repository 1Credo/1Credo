...
try:
    ...
    print(f'\t{red}[{ylw}!{red}] {bn}https://t.me/tech_hackers_100\n')
...
{lblue} █      █▀█      {red}# {grn}Coded By SOHIL CREDO.
{lblue} █      █▀█      {red}# {grn}TeleGrame {red}::: {ylw}Tech_hackers_100
{lblue} █▄▄▄▄▄▄███      {red}# {ylw}Version {red}2.1
"""
    
help = f"""
    {red}Usage {ylw}: {grn}python credo2.000.py [OPTION] ...
    ...
    {ylw}Use help 
        {grn}python {red}credo2.000.py {ylw}--ip{red}/{ylw}-I {red}[{grn}IP ADDRESS{red}]
"""
def Location(IP):
